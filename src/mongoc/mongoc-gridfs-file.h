...
struct _mongoc_gridfs_file_chunk_callbacks_t
{
   void (*after_chunk_read)   (mongoc_gridfs_file_t *file, const uint8_t **data, uint32_t *len);
   void (*before_chunk_write) (mongoc_gridfs_file_t *file, const uint8_t **data, uint32_t *len);
};
